    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 w-full max-w-sm shadow-2xl">
        ...
        <p className="text-white/70 text-sm text-center mb-6">
          Acceso restringido al personal autorizado. Inicia sesión con tu cuenta Google asignada.
        </p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-5 bg-white hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg"
        >
          {/* Google logo SVG */}
